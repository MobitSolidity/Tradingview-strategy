...
## Pushing the strategy to your GitHub account
1. Create a new (empty) repository in your GitHub account and copy its HTTPS or SSH URL.
2. From this project directory, run:
   ```bash
   git remote add origin <remote-url>
   git push -u origin main
   ```
3. For future updates, commit locally and push with `git push`.
